...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/chelseaharmon/Dropbox/danlab/Tasks/motorSequenceLearning/sequenceLearningTask.psyexp',
...
instructionsGeneral = visual.TextStim(win=win, name='instructionsGeneral',
    text="In this game you're going to see pictures of paw patrol characters. \nIt is your job to catch as many dogs as you can. \nUse the 1 2 3 4 keys and your first four fingers to catch the dogs when they show up in their positions.\nPress the buttons as fast as you can every time you see a dog to catch him before he escapes! \n\n\n\n\n\n(experimenter press spacebar)",
    font='Arial',
...
text = visual.TextStim(win=win, name='text',
    text='Press 1 when Chase is here ',
    font='Arial',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='Press 2 when Rubble is here ',
    font='Arial',
    pos=(0, .8), height=0.1, wrapWidth=None, ori=0, 
    color=1.0, colorSpace='rgb', opacity=1,
    depth=-1.0);
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='Press 3 when Marshall is here ',
    font='Arial',
    pos=(0, .8), height=0.1, wrapWidth=None, ori=0, 
    color=1.0, colorSpace='rgb', opacity=1,
    depth=-1.0);
...
text_4 = visual.TextStim(win=win, name='text_4',
    text='Press 4 when Rocky is here ',
    font='Arial',
    pos=(0, .8), height=0.1, wrapWidth=None, ori=0, 
    color=1.0, colorSpace='rgb', opacity=1,
    depth=-1.0);
...
goodJob = visual.TextStim(win=win, name='goodJob',
    text='You do it!!!! \n\nYou caught 463 paw patrol characters! ',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0);
